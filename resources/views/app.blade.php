...
<head>
    <title>DentOs Hub — Gestión clínica dental, en un solo lugar.</title>
    <link rel="icon" href="{{ asset('images/icon.webp') }}" type="image/gif" sizes="16x16">
    <meta content="text/html;charset=utf-8" http-equiv="Content-Type">
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="DentOs Hub — Gestión clínica dental, en un solo lugar." name="description">
                            ...
                            <div class="de-flex-col header-col-mid">
                                ...
                                <ul id="mainmenu">
                                    ...
                                    <li><a class="menu-item"
                                            href="https://ignisia-frontend.vercel.app/authentication/sign-in">Iniciar Sesión</a>
                                    </li>
                                    <li><a class="menu-item"
                                            href="https://ignisia-frontend.vercel.app/authentication/sign-up">Registro</a></li>
